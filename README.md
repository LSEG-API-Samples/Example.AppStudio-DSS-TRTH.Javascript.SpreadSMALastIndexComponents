...
In [SMA.html](Advanced-AppStudio-TRTH-DSS-Javascript-SpreadSMALastIndexComponents/SMA.html) a grid is used to display, for each component of the specified Chain, the following:
